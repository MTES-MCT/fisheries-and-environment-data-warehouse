...
-- service_id = NULL (colonne nullable, confirmée via
-- MissionGeneralInfoModel.kt -- @ManyToOne sans nullable=false -- pas
-- besoin d'une fixture "service" associée pour ce test).
...
INSERT INTO public.mission_general_info (
    ...
    ('999001', 999001, 42.0, 100.0, 150.0, null, 7,
