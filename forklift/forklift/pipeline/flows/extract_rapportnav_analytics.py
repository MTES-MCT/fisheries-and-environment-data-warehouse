...
col_patrol = [
    ...
    "isDeleted",
    "missionSource",
    "activity_operationalSummary_proFishingSeaSummary_total_nbControls",
    "activity_operationalSummary_proFishingLandSummary_total_nbControls",
    "activity_operationalSummary_proSailingSeaSummary_total_nbControls",
    "activity_operationalSummary_proSailingLandSummary_total_nbControls",
    "activity_operationalSummary_leisureSailingSeaSummary_total_nbControls",
    "activity_operationalSummary_leisureSailingLandSummary_total_nbControls",
    "activity_operationalSummary_leisureFishingSummary_total_nbControls",
    "activity_operationalSummary_envSummary_total_nbControls",
...
col_aem = [
    ...
    "4_4_1_nombre_d_heures_de_mer",
    "4_4_2_nombre_d_operations_scientifiques",
    "4_4_3_nombre_d_operation_de_police_des_b",
