CREATE TABLE IF NOT EXISTS sacrois.navires_mois_marees_jour (
    ...
    zsv_cod LowCardinality(Nullable(String)),
    ...
    stock_orgp LowCardinality(Nullable(String)),
    lieu_vente LowCardinality(Nullable(String)),
    lieu_vente_lib LowCardinality(Nullable(String)),
    ...
    montant_euros_ref__sipa Nullable(Float64),
